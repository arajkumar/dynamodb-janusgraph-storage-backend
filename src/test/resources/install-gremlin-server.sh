...
export JANUSGRAPH_SERVER_YAML_NEW=${JANUSGRAPH_GREMLIN_SERVER_CONF}/gremlin-server-new.yaml
...
cp ${JANUSGRAPH_DYNAMODB_TEST_RESOURCES}/gremlin-server-new.yaml ${JANUSGRAPH_SERVER_YAML_NEW}
